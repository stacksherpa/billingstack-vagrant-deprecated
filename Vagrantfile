...
Vagrant::Config.run do |config|
  ...
  config.vm.define :state do |vm_config|
    vm_config.vm.host_name = "state.stacksherpa.com"
    vm_config.vm.network :hostonly, "10.20.30.40"
    vm_config.vm.provision :shell, :path => "state.sh"
  end
